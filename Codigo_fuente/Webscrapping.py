...
def crearpantallaWS(pantalla,textos_fil,frameant):
    """
    ...
    :param str frameant: Representa el Frame anterior al que nos encontremos
    :return None
    """
    ...
    img = ImageTk.PhotoImage(Image.open("../recursor/pythonbutton.png").resize((280,280)))
    Frame_1.background = img
    bg = Frame_1.create_image(930, 360, anchor=tk.NW, image=img)

    def Frame_2(frameant):
        """
    ...
    def Frame_4(frameant):
        ...
        boton1 = tk.Button(Frame_4, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_4,5,frameant)).place(x=1090, y=580)

    def Frame_5(frameant):
        """
        ...
        boton1 = tk.Button(Frame_5, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_5,6,frameant)).place(x=1090, y=580)

    def Frame_6(frameant):
        """
        ...
        boton1 = tk.Button(Frame_6, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_6,7,frameant)).place(x=1090, y=580)

    def Frame_7(frameant):
        """
        ...
        boton1 = tk.Button(Frame_7, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_7,8,frameant)).place(x=1090, y=580)

    def Frame_8(frameant):
        """
        ...
        boton1 = tk.Button(Frame_8, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_8,9,frameant)).place(x=1090, y=580)

    def Frame_9(frameant):
        """
        ...
        boton1 = tk.Button(Frame_9, text="Siguiente", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_9,10,frameant)).place(x=1090, y=580)

    def Frame_10(frameant):
        """
        ...
        boton1 = tk.Button(Frame_10, text="Fin", font=("Comic Sans", 10), height=3, width=15, bg='#8EB7F3',fg='white', command=lambda: cambiar_frame(Frame_10,11,frameant)).place(x=1090, y=580)
        ...
        img = ImageTk.PhotoImage(Image.open("../recursor/pythonbutton2.png").resize((280,280)))
